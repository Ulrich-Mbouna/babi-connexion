<template>
  <div
      :class="!classes ? 'uk-child-width-1-3@s uk-flex-between uk-child-width-1-6@m uk-grid-small' : classes "
      uk-grid
      :uk-toggle="!classes ? `mode:media; media: (min-width: 375px); cls:uk-child-width-1-2` : '.test'"
  >
    <div class="uk-panel">
      <p class="test"></p>
